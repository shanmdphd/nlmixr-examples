...
fit.S <- nlmixr(wbc, d3, est="saem") %>% addCwres()

fit.F <- nlmixr(wbc, d3, est="focei")

pdf(file="wbc_model_evaluation_saem.pdf", height = 9, width = 9, paper = "letter")
...
pdf(file="wbc_model_evaluation_focei.pdf", height = 9, width = 9, paper = "letter")
